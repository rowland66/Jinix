 ...
 */
public enum PtyMode implements Serializable {
    ...
    public static Map<PtyMode, Integer> createEnabledOptions(PtyMode ... options) {
        Set<PtyMode> collection = new HashSet<PtyMode>();
        collection.addAll(Arrays.asList(options));
        return createEnabledOptions((Collection<PtyMode>) collection);
    }
    ...
    public static Set<PtyMode> resolveEnabledOptions(Map<PtyMode, ?> modes, PtyMode ... options) {
        Set<PtyMode> collection = new HashSet<PtyMode>();
        collection.addAll(Arrays.asList(options));
        return resolveEnabledOptions(modes, collection);
    }
    ...
    public static boolean getBooleanSettingValue(Map<PtyMode, ?> modes, PtyMode m) {
        if ((m == null) || modes == null || modes.isEmpty()) {
            return false;
        } else {
