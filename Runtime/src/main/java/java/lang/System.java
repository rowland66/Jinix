...
public final class System {
    ...
    public static Properties getProperties() {
        ...
        if (securityManager != null) {
            try {
                ...
                rtrn.putAll(props);
                rtrn.putAll(JinixSystem.getJinixProperties());
                for (String p : rtrn.stringPropertyNames()) {
                    if (JinixSystem.getJinixPropOverrides().contains(p)) {
                        rtrn.remove(p);
                    }
                }
                return rtrn;
    ...
    public static String getProperty(String key) {
        ...
        if (securityManager != null) {
            try {
                ...
                Properties jinixProps = JinixSystem.getJinixProperties();
                if (jinixProps.containsKey(key)) {
                    return jinixProps.getProperty(key);
                } else {
                    if (JinixSystem.getJinixPropOverrides().contains(key)) {
                        return null;
                    }
    ...
    public static String getProperty(String key, String def) {
        ...
        if (securityManager != null) {
            try {
                ...
                Properties jinixProps = JinixSystem.getJinixProperties();
                if (jinixProps.containsKey(key)) {
                    return jinixProps.getProperty(key, def);
                } else {
                    if (JinixSystem.getJinixPropOverrides().contains(key)) {
                        return def;
                    }
        ...
        return getPropertyNative(key, def);
    }

    private static String getPropertyNative(String key, String def) {
        SecurityManager sm = getSecurityManager();
        if (sm != null) {
            sm.checkPropertyAccess(key);
        }
    ...
    public static String clearJinixProperty(String key) {
        checkKey(key);
        return (String) props.remove(key);
    }
    ...
    public static String getenv(String name) {
        SecurityManager securityManager = System.getSecurityManager();
            ...
            try {
                ...
                throw new AccessControlException("Jinix programs cannot access the OS environment");
            }
        }
        return getenvNative(name);
    }

    public static String getenvNative(String name) {
        SecurityManager sm = getSecurityManager();
        if (sm != null) {
    ...
    public static java.util.Map<String,String> getenvNative() {
        SecurityManager sm = getSecurityManager();
        if (sm != null) {
