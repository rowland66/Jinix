        ...
        implements Serializable, Comparable<File>
{
    ...
    private JinixFile jinixFile;

    private boolean nativeAccess = true;

    /**
     * The FileSystem object representing the platform's local file system.
     */
    static private FileSystem fs = DefaultFileSystem.getFileSystem();
    ...
    private File(String child, File parent) {
        ...
        if (!nativeAccess) {
            this.jinixFile = new JinixFile(parent.getPath() + '/' + child);
        }
    }
    ...
    public File(String parent, String child) {
        ...
        this.prefixLength = fs.prefixLength(this.path);
        if (!nativeAccess) {
            jinixFile = new JinixFile(parent, child);
        }
    }
    ...
    public File getParentFile() {
        ...
        if (nativeAccess) {
            ...
            JinixFile jf = jinixFile.getParentFile();
    ...
    public File getAbsoluteFile() {
        ...
        if (nativeAccess) {
            ...
            JinixFile jf = jinixFile.getAbsoluteFile();
    ...
    public File getCanonicalFile() throws IOException {
        ...
        if (nativeAccess) {
            ...
            JinixFile jf = jinixFile.getCanonicalFile();
    ...
    public boolean canRead() {
        ...
        if (nativeAccess) {
            ...
            return true; // No authorizetion implemented yet
        }
    }
    ...
    public boolean exists() {
        ...
        if (nativeAccess) {
            ...
            SecurityManager security = System.getSecurityManager();
            try {
                security.checkPermission(new JinixNativeAccessPermission());
            } catch (AccessControlException e) {
    ...
    public void deleteOnExit() {
        ...
        //DeleteOnExitHook.add(path); // Not implemented yet.
    }
    ...
    public boolean renameTo(File dest) {
        ...
        if (nativeAccess) {
            ...
            return jinixFile.renameTo(new JinixFile(dest.getPath()));
        }
    }
    ...
    public boolean setLastModified(long time) {
        ...
        if (nativeAccess) {
            ...
            jinixFile.setLastModified(time);
            return true;
        }
    }
            ...
            throws IOException
    {
        ...
        File tmpdir = (directory != null) ? directory
                : TempDirectory.location(nativeAccess);
        SecurityManager sm = System.getSecurityManager();
        File f;
        do {
