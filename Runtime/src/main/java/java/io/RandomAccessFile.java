...
import org.rowland.jinix.io.JinixRandomAccessFile;
...
public class RandomAccessFile implements DataOutput, DataInput, Closeable {
    ...
    // Standard JDK Code ends here

    private JinixRandomAccessFile jinixRandomAccessFile;
            ...
            throws FileNotFoundException
    {
        ...
        if (jinixOnly) {
            path = null;
            jinixRandomAccessFile = new JinixRandomAccessFile(
                    (file != null ? new JinixFile(file.getPath()) : null), mode);
        } else {
            // Standard JDK Code starts here
    ...
    public int read(byte b[]) throws IOException {
        ...
        if (jinixRandomAccessFile != null) {
            return jinixRandomAccessFile.read(b);
        }
     ...
     * @exception  IOException  if an I/O error occurs.
     */
    public native long $$$Jinix$$$_getFilePointer() throws IOException;
     ...
     * @exception  IOException  if an I/O error occurs.
     */
    public native long $$$Jinix$$$_length() throws IOException;
     ...
     * @since      1.2
     */
    public native void $$$Jinix$$$_setLength(long newLength) throws IOException;
