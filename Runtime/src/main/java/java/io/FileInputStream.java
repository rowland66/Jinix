...
class FileInputStream extends InputStream
{
     ...
     * in the file system.  A new <code>FileServer</code>
     ...
     * A new <code>FileServer</code> object
    ...
    public int read() throws IOException {
        if (jinixFileInputStream != null) {
            return jinixFileInputStream.read();
        }
    ...
    public long skip(long n) throws IOException {
        ...
        throw new IOException("FileInputStream: skip() not supported for native FileInputStreams");
    }
    ...
    public int available() throws IOException {
        ...
        //throw new IOException("FileInputStream: available() not supported for native FileInputStreams");
        return 0;
    }
    ...
    /**
     * Returns the <code>FileServer</code>
